...
class GShape {
 public:
  virtual ~GShape() {}
  virtual void Draw(Window&, Shader, glm::mat4 = glm::mat4(1.0f)) const = 0;
};
...
class Triangle : public GShape {
 public:
  ...
  void Draw(Window&, Shader, glm::mat4 = glm::mat4(1.0f)) const override;
 private:
...
class Image : public Quadrangle {
 public:
  ...
  void Draw(Window&, Shader, glm::mat4 = glm::mat4(1.0f)) const;
 private:
  int nrChannels_;
  int width_, height_;
  unsigned int id_;
